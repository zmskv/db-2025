-- Примеры использования процедур, функций и триггеров
-- Демонстрация обработки ошибок

-- ============================================
-- Пример 1: Использование функции проверки доступности билетов
-- ============================================
...
-- ============================================
-- Пример 2: Создание заказа через процедуру (успешный случай)
-- ============================================
...
-- ============================================
-- Пример 3: Попытка создать заказ с недостаточным количеством билетов (обработка ошибки)
-- ============================================
...
-- ============================================
-- Пример 4: Попытка создать заказ с несуществующим пользователем (обработка ошибки)
-- ============================================
...
-- ============================================
-- Пример 5: Получение статистики по пользователю
-- ============================================
...
-- ============================================
-- Пример 6: Демонстрация работы триггера при добавлении позиции заказа
-- ============================================
...
-- ============================================
-- Пример 7: Попытка добавить позицию заказа с недостаточным количеством (триггер блокирует)
-- ============================================
...
BEGIN
    ...
    -- Получаем ID типа билета
    SELECT id INTO v_ticket_type_id FROM ticket_type 
    WHERE name = 'VIP' AND event_id = (SELECT id FROM event WHERE title = 'Zvuchok Fest');
    
    -- Попытка заказать больше, чем доступно (триггер должен заблокировать)
    INSERT INTO order_item (order_id, ticket_type_id, quantity)
...
-- ============================================
-- Пример 8: Демонстрация работы триггера аудита при изменении статуса заказа
-- ============================================
...
-- ============================================
-- Пример 9: Демонстрация работы триггера при обновлении количества в позиции заказа
-- ============================================
...
-- ============================================
-- Пример 10: Использование процедуры отмены заказа
-- ============================================
...
-- ============================================
-- Пример 11: Попытка отменить несуществующий заказ (обработка ошибки)
-- ============================================
...
-- ============================================
-- Пример 12: Демонстрация работы триггера при удалении позиции заказа
-- ============================================
